...
\DeclareFactoid{sohcahtoa}{{\textbf{Definitions of sin/cos/tan}}\\
{\begin{minipage}{.05\linewidth}{\phantom{.}}\end{minipage}\begin{minipage}{.25\linewidth}\phantom{.}\\
...
\draw (81.33,10.23) node [anchor=north west][inner sep=0.75pt]  [rotate=-29.88] [align=left] {Hypotenuse};
\draw (10.99,98.99) node [anchor=north west][inner sep=0.75pt]  [rotate=-269.68] [align=left] {Opposite};
\draw (80,114) node [anchor=north west][inner sep=0.75pt]   [align=left] {Adjacent};
