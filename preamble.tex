...
\DeclareFactoid{power laws}{{\textbf{\color{pink}Rules for Powers/Exponents}}\\[3pt]
...
\DeclareFactoid{log laws}{{\textbf{\color{pink}Rules for Logarithms}}\\[3pt]
%v1_050822_764959481070616617
\colorbox{gray}{\begin{tabular}{l|l}
\hline
\\[-10pt]Product Rule&$\log_a(xy)=\log_a x+\log_a y$\\[5pt]\hline
\\[-10pt]Quotient Rule&$\log_a\left(\frac{x}{y}\right)=\log_a x-\log_a y$\\[10pt]\hline
\\[-10pt]Power Rule&$\log_a\left(x^y\right)=y\log_a x$\\[5pt]\hline
\\[-10pt]Change of Base&$\log_a x=\frac{\log_bx}{\log_ba}$\\[10pt]\hline
\\[-10pt]Inverse&$a^{\log_a(x)}=\log_a\left(a^x\right)=x$\\[5pt]\hline
\\[-10pt]Log of One&$\log_a(1)=0$\\[5pt]\hline
\\[-10pt]Log of Base&$\log_a(a)=1$\\[5pt]\hline
\end{tabular}}}

\DeclareFactoid{trig id}{{\textbf{\color{pink}Trig Identities}}\\[3pt]
%v1_120822_764959481070616617
\colorbox{gray}{\begin{tabular}{c}
\hline
\\[-10pt]$\sin(\theta+\gamma) = \sin(\theta)\cos(\gamma) + \cos(\theta)\sin(\gamma)$\\[5pt]\hline
\\[-10pt]$\cos(\theta+\gamma) = \cos(\theta)\cos(\gamma) - \sin(\theta)\sin(\gamma)$\\[5pt]\hline
\\[-10pt]$\sin(2\theta)=2\sin(\theta)\cos(\theta)$\\[10pt]\hline
\\[-10pt]$\cos(2\theta)=\cos^2(\theta)\sin^2(\theta)$\\[5pt]\hline
\\[-10pt]$\cos^2(\theta)+\sin^2(\theta)=1$\\[10pt]\hline
\\[-10pt]$sin(-\theta)=-\sin(\theta)$\\[5pt]\hline
\\[-10pt]$\cos(-\theta)=\cos(\theta)$\\[5pt]\hline
\\[-10pt]$\tan(\theta)=\frac{\sin(\theta)}{\cos{\theta}}$
\end{tabular}}}

\DeclareFactoid{sohcahtoa}{{\textbf{\color{pink}Definitions of sin/cos/tan}}\\[3pt]
%v1_050822_764959481070616617
